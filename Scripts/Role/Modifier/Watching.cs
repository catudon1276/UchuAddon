...
public class WatchingU : DefinedAllocatableModifierTemplate, DefinedAllocatableModifier
{
    private WatchingU() : base("watchingU", "WTC", new(87, 38, 166))
    {
        ConfigurationHolder?.AddTags(AddonConfigurationTags.TagUchuAddon);
    }
    static internal Image IconImage = NebulaAPI.AddonAsset.GetResource("RoleIcon/Watching.png")!.AsImage(100f)!;
    Image? DefinedAssignable.IconImage => IconImage;
    static public WatchingU MyRole = new WatchingU();
